...
namespace BitcoinForecast
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Coding Space\Project\Group3\bitcoin-hourly-technical-indicators.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:2,seriesLength:10,trainSize:136033,horizon:30,outputColumnName:@"CLOSE",inputColumnName:@"CLOSE",confidenceLowerBoundColumn:@"CLOSE_LB",confidenceUpperBoundColumn:@"CLOSE_UB");
